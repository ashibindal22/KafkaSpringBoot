...
public class KafkaConfig {
	...
	{
		logger.info("Inside ConsumerFactory of KafkaConfig");
	...
	{
		logger.info("Container Factory for Listeners");
	...
	{
		logger.info("Inside userConsumerFactory of KafkaConfig");
		Map<String, Object> config = new HashMap<>();
		config.put(ConsumerConfig.BOOTSTRAP_SERVERS_CONFIG, "127.0.0.1:9092");
	...
	{
		logger.info("userContainer Factory for Listeners");
